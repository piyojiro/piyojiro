...
$httpClient = new \LINE\LINEBot\HTTPClient\CurlHTTPClient('ooNXytK/brsAZLBJnVb8fzLwOAKJNGcsPXSeb8o/NNm7IDi65U/qakqgy1z3YH7bbEOhFc3g9W5gt7oVsOdZPgTYLA84+GRX5kCfD8Nj2kIu0P6gh3WbhVG7gKvH+xjIZ6QlwLqrQ7GnvJzm7NtLngdB04t89/1O/w1cDnyilFU=');
...
foreach ($events as $event) {
  ...
  //好きなテキストを送信
  $returnText = $event->getText();
  replyTextMessage($bot, $event->getReplyToken(), $returnText);
